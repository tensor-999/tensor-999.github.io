...
// 캐릭터 정보
const characters = {
    "아서": { id: "Arthur_s", fileName: "arthur_RE.json", enabled: true },
    "샬럿": { id: "zzZZzz", fileName: "charlotte_RE.json", enabled: false },
    "니나": { id: "NINA", fileName: "nina_RE.json", enabled: false },
    "위스테라이": { id: "Nightmare", fileName: "wiz_RE.json", enabled: false },
    "딜런": { id: "DylanRossini", fileName: "dylan_RE.json", enabled: false },
    "리키": { id: "RICKYBANG", fileName: "ricky_RE.json", enabled: false },
    "윈터": { id: "Winter", fileName: "winter_RE.json", enabled: false },
    "제이어드": { id: "DD_Jayard", fileName: "j_RE.json", enabled: true },
    "루": { id: "LuBu3", fileName: "lu_RE.json", enabled: true },
    "엘가": { id: "Elgar", fileName: "elgar_RE.json", enabled: true },
    ...
    "카이퍼": { id: "Kuiper", fileName: "kuiper_RE.json", enabled: true },
...
function isDM(noteObj) {
    const dmTargets = [
        "https://occm.cc/users/NOTICE_PD",
        "https://occm.cc/users/SYSTEM_PD"
    ];
...
async function fetchJsonFromDrive(fileName) {
    const fileId = driveFilesRE[fileName];
...
async function initApp() {
    try {
        ...
        driveFilesRE = config.driveFilesRE;
